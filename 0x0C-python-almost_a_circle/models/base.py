#!/usr/bin/python3
"""Defines a base module by Okpako Michael"""
import json
from os import path
...
class Base:
    ...
    Attribute:
        __nb_objects (int): number of objects, yeah, the number of objects
    """

    __nb_objects = 0

    def __init__(self, id=None):
        """__init__ initialize base class, yeah the base class
    ...
    def to_json_string(list_dictionaries):
        """Returns the JSON string representation of list_dictionaries, JSON string does this"""
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON string representation of list_objs to a file or files"""
    ...
    def from_json_string(json_string):
        """Returns the list of the JSON string representation, using a static method"""
    ...
    def create(cls, **dictionary):
        """Returns an instance with all attributes already set, all already set"""
    ...
    def load_from_file(cls):
        """Returns a list of instance or instances"""
